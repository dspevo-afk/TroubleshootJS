...
try:
 with sync_playwright() as p:
  ...
  try:
   ...
   report=page.locator('html').get_attribute('data-tsj-q15-report' if mode.startswith('q15') else 'data-tsj-p07-report')
   ...
   expected = 'FAIL:q15:q15-explicit-failure-canary' if mode=='q15negative' else 'FAIL:P07 forced-negative' if mode=='negative' else 'PASS:'+('p07' if mode=='bench' else mode)
