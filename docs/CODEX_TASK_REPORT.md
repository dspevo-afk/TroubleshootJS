...
- **Next:** Inspect intended/staged diff, commit, push and verify origin SHA, notify through connected Gmail. Then implement and qualify the separately authorized major visual/productization pass, with its own commit/publication. Stop before P05.

## Historical checkpoint - Q15 complete and qualified - 2026-09-13

- **Scope/candidate:** Q15 only, branch `codex/task43p-final-recovery`, base `99a0001982ad92d245fda1e38a9c7ea1045da3a3`. The commit containing this checkpoint identifies the accepted candidate. Its normal push/remote SHA and authorized Gmail result are recorded in the final handoff after publication. **Next unstarted milestone: U04.** [Q15 evidence](task-evidence/Q15/README.md).
- **Delivered:** Sixteen-package RB15 control board with independent named-stream topology/support/fault/placement/routing choices, four BJT/NMOS x RC/resistive designs, real protected 12 V power and 5 V command, three faults across RDRIVE/K1 and solver-backed HIGH/LOW repair checks. Procedural bottom copper, layout7/dependency7, job-owned resumable routing and fresh sealed layout containers preserve exact electrical/physical ownership. The authored nine-part E03 reference remains separate.
- **Final gates:** Maintained native PASS:30 Java suites, Q15 6,713 assertions/all eleven seeds, independent seed/value/role oracles and report protocol. Actual five-permutation JDK8/GWT PASS (81.304 s compile/1.412 s link). Compiled Q15 PASS481/80 support assertions, eleven seeds/four designs/three faults/all six stages, forced-negative cleanup and strict reader. Each case physically repairs all three diagnostic hypotheses and rejects its selected unrepaired/wrong repair. Original owner restored in 3 ms. Fresh E03 PASS46+113/six cases, A08 PASS1103/90 compensated writes/five fresh failures, Task49 PASS397/four solved cases, Task41 PASS20 routes/182 samples, A10 PASS1273/24 attempts/two RC runs, and focused native Quick Play checks PASS. Final maintained evidence readers and negative canaries PASS.
- **Performance/provenance:** Compiled admission p50/p95 36.657/80.627 s; routing 10.171/41.667 s; proof 21.998/38.413 s. Active unit maximum2.797 s and at most120 work units preserve 90 s/5 s/640 guards. Routing cancellation handler0 ms at millisecond resolution does not bound input queues. All 1,076 source/test/script inputs and five compiled permutations rechecked unchanged; execution digest `4ce82866bd75fc1ed801a1e1799434f882605e7d5c294390c7019a24191fe605`, preview identity matched. Only documentation/evidence changed after final-source gates.
- **Player/review:** Fresh production Browser flows prove unrepaired failure, partial/all source isolation, real parallel-path OHM readings, removal/tray/catalog repair, HIGH/LOW measurement and successful retest. NMOS accepts a valid 100 kOhm alternative; BJT rejects the 5 V relay before accepting 12 V. Five inspected screenshots include bottom copper, explicit visible cancellation and +12/-12 V direct left/right probe reversal. Verifier flags without debug expose no report or answer. Root integrated review found no unresolved blocker; independent agent review NOT RUN (optional).
- **Limits/retained failures:** This sixteen-package family does not qualify arbitrary circuits at every 5-20-part size. Cohort failures informed fixes, so it is not a random-population success-rate estimate or cold-process benchmark. Earlier routing/build/timeout/ownership/discharge/flyback/renderer failures remain recorded. Initial A10 RC profile-boundary FAIL had no complete report or established cause; the unchanged candidate passed after completed simulator tabs were closed, and its strict reader passed. Earlier visible cancellation input attempts lacked a confirmed result before the final successful DOM-node click. A11-D1 and historical Windows browser-wrapper qualification limits remain; no mains/arcing/EMC, larger boards, advanced profiles or general trace-repair claim.
- **Resources/preserved:** All task Browser tabs closed; final tab list empty. Preview PID18720/start `2026-09-13T03:55:54.5877213Z`/port64115 was ownership-checked and stopped in16 ms. No active task process remains. Automatic approval review blocked combined shutdown/recursive scratch cleanup; narrower shutdown passed and scratch classes/logs were retained, with no alternate deletion. OS-temp directory ends `Q15-9de3ad5ef0374dcc80777a0afcb25547`. Foreign preview and pre-existing `tests/contracts/__pycache__/` remain untouched. [Cleanup limits](task-evidence/Q15/resource-cleanup.json).
- **Publication/next:** Accepted pre-publication checkpoint. Complete explicit staging/cached review, concise commit, normal configured-origin push, remote-SHA verification and established Gmail notification. No later milestone is authorized by this task.

## Historical checkpoint - E01 and E03 complete - 2026-09-12

- **Scope/candidate:** E01 and E03 are COMPLETE - QUALIFIED. Branch `codex/task43p-final-recovery`, base `d2e9d35ed2dea2937fda79d8a41a87f882a819dc`; the commit containing this checkpoint identifies the publication candidate. All 1,069 final source/test/script fingerprints were rechecked unchanged: `26c2575661e67a7aa27a78188e08a918c5629ba51109ae9b6ea3db8d6c8a4407`. Dependency epoch6 / source-load dump model3. [E01](task-evidence/E01/README.md), [E03](task-evidence/E03/README.md).
- **Delivered:** Real bounded nonlinear supplies, independent bench disconnect/current settings, solved readout, finite backfeed and persistent fuse/load failure. An isolated five-terminal relay family has BJT/NMOS drivers, actual RL flyback, coil/contact/drive faults, compensated replacement and HIGH/LOW retest. Active meters settle and discharge real coil energy. Typed reference policy rejects unqualified cross-domain DC; private rollback preserves partial isolation and selected current limits.
- **Final gates:** PASS: 29 native suites (E01 96,015 assertions; E03 161; A06 152), independent seed/value/role oracles and strict readers; actual JDK8/GWT five permutations (60.888 s compile, 1.256 s link). Compiled E01 PASS21; E03 PASS46 raw +113 mutation assertions/all six cases (1,755 ms raw, 34,723 ms total); Task41 PASS17 routes/155 solver samples; Task49 PASS397/four solver cases; A08 PASS1103/90 compensated writes/five fresh failures (42,050 ms). Both forced negatives fail closed. The final evidence-reader command passes all electrical thresholds, five malformed-proof canaries and unchanged Task41/Task49/A08 readers (0.550 s). Cleanup timing is separate.
- **Player/review:** Final visible LED flow passes failed retest → off-board-power 100 kOhm reading → 1 kOhm replacement → real 1 mA limiting/failed retest → 250 mA/passed retest; three new inspected images. Final NMOS relay flow passes normal admission, failed retest, cross-domain rejection, partial/all isolation, 124.999 Ohm healthy coil, replacement, HIGH 11.983 V / LOW 2.16 µV and customer retest; four new inspected images. Earlier BJT open-coil/wrong-12 V/correct-5 V flow and fifth relay image have an explicit reuse audit; final compiled proof freshly covers both drivers and all faults. Root integrated review resolved source declarations, reference, malformed-input and snapshot-restore findings. Separate agent review NOT RUN (optional).
- **Limits/failures:** Relay mechanics, leakage, source compliance and load/fuse stress use the documented bounded models; no arcing/EMC/mains, general routing expansion, larger-board or trace-repair claim. Earlier failed admission/compilation/solver/browser attempts remain recorded, never substituted for final PASS. Historical Windows CLI/CDP-wrapper qualification, RC cost and A11-D1 coverage debt remain. [Retained failures](task-evidence/E03/retained-failures.json).
- **Resources/preserved:** Exact preview PID8456/start639248515511146017/port64932 was identity-checked and stopped (30 ms). Successful/old HTTP test tabs closed; crashed Browser tab4 remains because the supported close rejects its generated data URL. No active verification job remains. Raw logs/receipts/focused classes remain in the owned OS-temp directory recorded in [resource evidence](task-evidence/E03/resource-cleanup.json). Pre-existing `tests/contracts/__pycache__/` and foreign preview state are preserved. The pre-edit Windows memory event named computer-use at about30.8GiB; this task did not use it and post-restart available memory remained above21GiB.
- **Publication/next:** This is the accepted pre-publication checkpoint. The final handoff records the actual normal origin push, remote-SHA verification and authorized Gmail notification after they occur. No unrequested milestone was started. **Next: Q15**, requiring new scope.

## Historical checkpoint - U01, P03, P04 complete; A11-R1 closed - 2026-09-12
...
## Historical checkpoint - Updated execution order integrated - 2026-09-12

- **Scope/state:** Documentation-only update from `TroubleshootJS_Preferred_Execution_Order_UPDATED.md`. Branch `codex/task43p-final-recovery`, HEAD `0487555d6bd2e5e8ed4b01652b847d0fffcb900c`. The owner requested no commit or push; roadmap and this handoff remain uncommitted.
- **Changed:** Roadmap Sections 7.1/7.2 now reflect all 16 accepted entries and one remaining queue: U01 → P03 → P04 → E01 → E03 → Q15 → U04 → U05 → REL-A, followed by the supplied normal/advanced/mature waves. E08 remains conditional on consuming content; card scopes, prerequisites and acceptance are unchanged.
- **Validation:** Compared the updated queue with current card statuses and hard prerequisites; all named prerequisites precede their consuming milestones. Documentation diff/whitespace checked; no build or runtime tests apply to this change.
- **Preserved/resources:** Pre-existing untracked `tests/contracts/__pycache__/` is untouched. No agents, previews or test processes were started. Earlier implementation evidence and resource limitations remain in the historical checkpoint below.
- **Next session:** Preserve these uncommitted documentation edits. A10/A11 are complete; U01 is next and unstarted. This request updates planning only and does not authorize implementing U01 or later milestones.

## Historical checkpoint - A10 and A11 complete - 2026-09-12
...
- **Candidate:** Six-stage generation, complete resumable hypotheses, typed rejections, immutable plan cache and dependency receipts, transactional publication and guarded cleanup. Scenario metadata/semantic epoch are captured under interpretation v3. All 1,055 frozen inputs and five compiled permutations remain unchanged through final qualification.
- **Gates:** PASS: final native 23 suites (190 generation/26 routing/12 dependency, independent oracles/report466, cleanup, exit 0); final JDK8/GWT five permutations; compiled A10/strict reader 1,273 assertions and 24 attempts; A07/A08/Task41/Task49 strict readers; A09 97 assertions/11 negatives plus reader144; P02 NPN/RC/composed; forced failure/privacy; real cancellation and LED OL → 330 Ohm replacement → successful powered customer retest. [Evidence and retained failures](task-evidence/A10/README.md).
- **Review/limits:** Optional fresh source review found no blocker; scenario-dependency finding resolved. D1: queued repaint closures temporarily retain old boards in synchronous verifier bursts. RC admission is 55,883/48,243 ms, maximum active unit 4,371 ms; cancellation-handler cleanup max 5 ms does not bound queued input. Explicit runtime guard is 90 seconds/640 units; five-second active units and existing solver limits remain. First long-lived-tab Task41/A09 crashed; isolated retry passed. Historical Windows browser wrapper remains unqualified.
- **Resources:** Preview port 64817 and Browser tab 4 remain root-owned for A11; exact PID/start/executable are in external owner receipts. Tab 2 crash page is retained because Browser URL policy rejected closure. Routing scratch `<OS temp>/troubleshootjs-a10-routing-final-5b4a70e466af43ddbaec4ffaadf1d883/` is retained after automatic approval review blocked guarded deletion. Root scratch `<OS temp>/troubleshootjs-a10-a11-67333b42a74d44b089f27158daf1eecb/` retains raw evidence. No build/native or worker process remains. Pre-existing `tests/contracts/__pycache__/` is preserved/excluded.
- **Next:** Commit/push A10, verify origin SHA and send the established Gmail notification. Then implement A11; stop before U01, the next unstarted item in the preferred queue.

## Historical checkpoint - P02 accepted; A10 then A11 authorized - 2026-09-12

- **Scope/base:** Owner supplied the P02 independent PASS and requested A10 then A11. Close P02 publication first. Branch `codex/task43p-final-recovery`; P02 base `79be5ac5687aa3ad8552dc063a0434838ff1bf1d`; reviewed complete patch SHA-256 `0326cdb8a09ae8ee2cd309d178cad29fa09a9340e81bb075be3ea1303796f5b8`.
- **Review:** Fresh separate-session delta review PASS; F1 RESOLVED; no blocking findings. Corrected the stale roadmap assertion count and review status (D1). Earlier quota-blocked attempts are preserved below. [Review summary](task-evidence/P02/independent-review.json).
- **Qualification reuse:** All 46 candidate files, 642 source/test inputs, eight runners/readers and five compiled permutations match the reviewed hashes; complete patch hash and reverse-application check PASS. Reuse the unchanged final production build, native/browser and oracle evidence. This closeout changes only documentation after that audit; no new runtime validation is claimed.
- **Limits:** The old Windows wrapper remains unqualified; no native player-input gate or E08 gameplay is claimed for P02. Pre-existing `tests/contracts/__pycache__/` is preserved and excluded.
- **Work/resources:** Root owns P02 closeout and shared architecture. Read-only Luna MAX investigators `a10_boundaries` and `a11_registry_map` own their respective code-path maps; no worker writes or test processes. Speed is not separately exposed by the spawn interface. Scoped scratch is `<OS temp>/troubleshootjs-a10-a11-67333b42a74d44b089f27158daf1eecb/`.
- **Next:** Commit/push P02, verify origin contains the accepted SHA and notify through connected Gmail. Then reconcile A10 interfaces and acceptance gates before implementation; A11 follows A10. No publication result is asserted before execution.

## Historical checkpoint - P02 F1 repaired; independent delta review blocked

- **Scope/base:** Implement the independent review repair and close P02. The repair and final behavior qualification are complete, but acceptance/publication remains blocked by the required fresh review. Branch `codex/task43p-final-recovery`; unchanged HEAD/base `79be5ac5687aa3ad8552dc063a0434838ff1bf1d`. No P02 commit/push/mail; A10 remains unstarted.
- **Repair:** `PcbConductorBuilder` now gathers all segment-contact and pad breakpoints by physical layer/supporting line, then distributes them inside every segment before edge emission. Coincident copper intervals retain merged provenance rather than duplicate cuttable paths. No new player feature or solver mutation adapter.
- **Regression:** The maintained F1 regression fails on the old builder. The repair passes both layers/orientations, all six source orders and original/reversed-subdivided paths (48 combinations). It asserts one shared interval, both provenances, physical cut/disconnection, immutable pristine state, save/restore and no positive-length duplicate collinear TRACE edges.
- **Fresh validation:** PASS: 20 native suites; P02 3,209 assertions; P01 8,357 assertions/43 poses; the unchanged original independent minimal reproduction and 500-fixture off-grid probe (198,987 assertions); actual final JDK8/GWT OBF build with all five permutations; all 12 compiled routes with zero page errors; actual A08/Task49 strict readers; three maintained Python oracles; report protocol 466 assertions. All 642 source/test hashes remained unchanged after qualification. [P02 evidence](task-evidence/P02/README.md).
- **Review:** Original full-candidate review: CHANGES REQUIRED, F1 code blocker. F1 is repaired and its independent-authored probes now pass. Both fresh Luna MAX/default-speed and Reserve targeted delta-review requests exited 1 at quota before substantive review. Implementer reconciliation and independent test oracles do not constitute a fresh independent review. [Repair results](task-evidence/P02/repair-results.json).
- **Limits:** The prior Windows native-wrapper exit 2 remains separately unqualified and was not rerun unchanged. No native mouse/keyboard workflow, U01 controls, E08 live trace cutting, SMD player catalog or two-layer autorouter is claimed. Existing bounded-scale and extreme route-score follow-ups remain unchanged.
- **Resources/next:** Build/native/oracle/browser/reviewer jobs exited; browser contexts closed and preview-server thread stopped. Pre-existing `tests/contracts/__pycache__/` is preserved and excluded. Raw receipts, runners, final native classes, complete candidate and repair-only delta are in `<OS temp>/troubleshootjs-p02-repair-hl16rpvw/`. Obtain an independent targeted review of the three-file F1 delta, reconcile any findings, then accept/commit/push/notify P02. Do not start A10.

## Historical checkpoint - P02 before independent F1 review

- **Scope/base:** Resume the authorized P02 implementation after publishing P01. Branch `codex/task43p-final-recovery`; unchanged patch base/HEAD `79be5ac5687aa3ad8552dc063a0434838ff1bf1d`. P01 is already accepted, pushed and notified. P02 remains uncommitted; A10 is unstarted.
- **Implemented:** Normalized layer-aware physical copper, stable current-realization junction/edge IDs and provenance, plated lands/barrels/vias and NPTH, immutable pristine/current snapshots, transactional projection contract, sealed layouts, actual CircuitJS correspondence audit, and face/exposure-correct rendering/probing. Redundant source routes cannot preserve a cut shared physical trunk.
- **Final native/build:** PASS: 20 maintained JDK8 suites; P02 1,815 assertions, 40 independent lattice cases and 16 SMD poses; P01 8,357 assertions and 43 poses. Final actual JDK8/GWT OBF build passed all five permutations. All final Java/test inputs are fingerprinted in [P02 provenance](task-evidence/P02/candidate-provenance.json).
- **Final compiled/oracles:** PASS: all twelve planned routes, including P02 on LED, diode, RC, NPN, NMOS, parallel and composed controlled-indicator boards; P01, A08, Task49, forced rejection and debug-off privacy. Actual A08/Task49 strict report readers, three maintained Python oracles against final Java receipts, and the 466-assertion report protocol passed. Zero ordinary page errors. [Evidence and qualifications](task-evidence/P02/README.md).
- **Corrected failures:** Three initial P02 routes missed dispatch after delayed admission; P02 now runs from the normal update cycle with all readiness/non-reentry guards retained. Fresh final routes pass. An intermediate JSONString dependency failed GWT compilation; native JSON quoting removed that dependency and the final build passed. Failed runs are retained, not relabeled.
- **Independent review:** BLOCKED. Fresh Luna MAX/default-speed and authorized Reserve read-only review attempts both returned usage-limit errors before substantive review. Root reconciliation is not independent review. P02 acceptance and publication are withheld.
- **Limits:** The historical Windows Python-launch wrapper exit 2 remains separately unqualified. No native mouse/keyboard workflow was run. Physical cut snapshots and transaction doubles are not live E08 trace-cut gameplay: current game owners reject copper edits without an installed solver adapter. No U01 viewing controls, SMD player catalog, two-layer autorouter, or A10 implementation is claimed.
- **Resources/next:** Final browser contexts and preview server closed; no worker review remains active. Pre-existing `tests/contracts/__pycache__/` is preserved and excluded. External complete patch, raw logs, runners and checkpoint are under `<OS temp>/troubleshootjs-p02-retry-xmrsbgf3/`. Obtain a fresh independent review of this exact integrated candidate, reconcile any findings and affected gates, then accept/publish P02. The pre-existing extreme route-score accumulation follow-up remains nonblocking.

## Historical checkpoint - P01 accepted; publication authorized
...
- **Corrections:** Preserved v1 historical incorrect-resistance fault semantics; tracked ownership before derived NMOS posts exist; removed double origin translation; retained persistent device-side pads and their exact canonical endpoint references; enforced bound-unit completion, opposite-terminal rejection, exact bridge identity, and abort revocation. Original Task47/48/49 assertions and golden fixtures were not weakened.
- **Native:** Final root-run report protocol 103; A03 shared 109 / replay 29; A02 candidate PASS / geometry 66 / replay 112; package 37; construction 433; actual physical declarations 730. Existing independent Task46 seed and Task47/48/49 assembly/value oracles PASS; cleanup PASS.
- **Production build:** Final standard JDK 8u502/GWT 2.7 all five OBF permutations PASS (58.185 s compile, 1.222 s link). All 987 source/script/test input hashes remained unchanged through final qualification.
- **Compiled A04:** PASS: 204 context assertions / 238 runtime assertions, versions 1/2/3, expected forced failure and debug-off, original owner restored, cleanup=true.
- **Compiled regressions:** All nine A03/Task41/46/47/48/49/A02 routes PASS, including existing raw physical-truth and real repair/retest checks; cleanup=true. Task47/48/49 retain 1,540 / 755 / 1,053 assertions.
- **Replay/provenance:** Exact native/compiled/baseline A03 vectors and all three manifests. Complete Task41/46/A02 reports exact. Task47/48/49 differ only in transient node renumbering and qualified numerical observations; terminal partitions and all other fields remain exact. Final source/script/web/execution identities match both browser receipts and the 1,320-file recomputed execution provenance.
- **Environment/evidence reuse:** Heavy Task41 required the existing configurable 300-second application-route window; earlier 90-second failures remain disclosed. A04 used 90 seconds. All 500 ms ownership limits, core preview, and verifier-isolation implementation remain unchanged; accepted Gate B lifecycle proof is reused for those exact unchanged dependencies, not claimed freshly rerun.
- **Independent review:** PASS after separate Luna MAX corrective reviews and a final independent review resumed through the documented `gpt-reserve` MAX fallback when ordinary Luna usage exhausted. The failed ordinary review invocation is not counted as PASS. Root separately completed the runtime gates left to it by the static reviewer.
- **Follow-ups:** Three nonblocking materializer/declaration defense-in-depth checks are recorded in `docs/task-evidence/A04/independent-review.md`. Existing fixed/mutable-resistor categories only; interpretation-bearing future saved actions remain unsupported. No Q60/Q100, importer, or MCU qualification is claimed.
- **Evidence/resources:** `docs/task-evidence/A04/README.md` indexes final receipts, exact inputs, provenance, comparison, and review adjudication. No final task-owned browser, preview, test, or worker process remains; external task scratch is retained as historical diagnostic evidence. Historical A03 orphan artifacts remain untouched.
- **Publication boundary:** Source and evidence are qualified for normal commit/push by the root. Publication confirmation and exact final SHA are recorded in the completion notification only after the remote is verified. A05 remains unstarted.

## Historical A04 prequalification checkpoint

- **Scope/base:** Authorized A04 provider-owned electrical construction above `1d995d4f5b21142d4ca5643ede546afdfe51340f` on `codex/task43p-final-recovery`. Entry was clean. All A04 changes remain uncommitted; A05 and later milestones remain unstarted.
- **Implementation:** Existing bounded versions 1/2/3 use a plan-owned immutable electrical spec, local typed construction providers, exact device-owned bridges, one private allocation/binding context, provider-declared physical parts, and a generic materializer. No new family, solver, importer, gameplay or general rollback framework.
- **Root corrections:** Real one-context CircuitJS isolation replaces the original two-context false-positive oracle. Abort revokes retained bindings/receipts and returns actual cleanup status. Exact component-side terminal representations reject opposite-terminal and secondary-path bypass. All typed device allocation rejects declared bridge IDs outside the join API. The positive supply attachment has explicit external-input provenance rather than a false common-return label.
- **Legacy staging:** A device-owned resistive stage preserves the original actual 9-element MERGE and 16-element completed graph. The old Task47 five-stage failure assertions are unchanged; their compiled execution is still pending.
- **Native validation:** Latest root JDK8 A04 run PASS: report contracts 103, A03 identity 29, A02 candidate/geometry 66/replay 112, package map 37, construction 433, owned scratch cleanup. All Task44/45/46/47/48/49 pure contracts and independent Python oracles PASS. Native A03 vectors and all three canonical manifests byte-match accepted A03 artifacts.
- **Production build:** Fresh standard JDK8/GWT OBF compile PASS for all five permutations (123.088 s compile, 3.988 s link). Root captured 954 source/script/test inputs before the final run; no concurrent writer was permitted. No later source mutation is accepted without requalification.
- **Browser evidence:** Actual owned transport smoke PASS with cleanup. Full compiled A04 and historical All-nine-route electrical/regression gates remain pending; a smoke test is not product qualification.
- **Environment:** Noninteractive subprocesses now receive closed/null standard input, preventing inherited console input from stalling Python startup. The installed uv Python 3.12.8 runs the unchanged independent oracles. Listener-query code initialization before a target lease resolves cold-start latency; every target lease still performs fresh ownership checks within the unchanged 500 ms contract. No saved authorization or target listener is reused.
- **Review:** Fresh integrated Luna review found two blockers. Root patched both and added regressions; independent targeted delta review is running. The physical-discard comment is classified as follow-up pending final adjudication of the unpublished object lifecycle. No independent PASS is yet claimed.
- **Resources/publication:** Root orchestration REPL and one read-only reviewer remain active. No task browser/listener is retained. Scoped scratch and truthful failed attempts remain available. No A04 commit, push or completion email has been made.
- **Next:** Reconcile delta review, execute the compiled electrical gates and exact parity checks, curate evidence, then publish only after all required gates pass.

## Historical pre-publication checkpoint - A03 COMPLETE — QUALIFIED — 2026-09-08
...
- **Scope/candidate:** This owner-authorized pass repairs exactly three A01
  ...
  `3b4fd13db927a673a1d106bdb1ac7d19af9dea12`, branch
  `codex/task43p-final-recovery`. Implementation commit is
  `fdabfea1ab6ea0324ba39d76b6ad4173e9bea869`; A02 and later work remain outside
  scope. The
  final source/build fingerprints are recorded in
  [corrected-identity-summary.json](task-evidence/A01/corrected-identity-summary.json).
- **Root causes/fixes:** Collector exceptions previously retained `PASS` and
  the checker trusted the embedded report; the collector now forces retained
  exceptions to `INFRASTRUCTURE_FAILURE` and the checker validates wrapper,
  terminal, report, cleanup and error consistency. The checker previously
  accepted missing/over-budget/inconsistent timing; it now requires finite
  bounded totals, per-attempt limits, trace intervals and aggregate timing.
  URL labels previously were not proof of the running artifact; preview-served
  provenance is now stamped into the loaded DOM, read by Java, retained by the
  collector and compared by the checker.
- **Validation:** Focused Python and Node contract suites PASS, including cases
  1–10; references, block, assembly and challenge checks PASS; final JDK
  8u502/GWT 2.7 OBF production build PASS for all five permutations. Fresh
  Browser-backed pilot and holdout each PASS with 16 attempts/32 accepted steps;
  the independent pair check PASS with 32 attempts/64 accepted steps. The
  forced route retained `FAIL:a01` and the checker rejected it; debug-off
  retained no report or terminal result.
- **Review:** Fresh independent `create_thread` reviewer
  `01a07d96-ab4a-7b22-b6da-ebb31db3dc5e` returned PASS with no blockers. It
  independently traced all three fixes through the Java, preview, collector and
  checker paths, checked the ten acceptance cases and corrected evidence, and
  recorded one nonblocking single-corpus follow-up in
  [corrected-review-summary.json](task-evidence/A01/corrected-review-summary.json).
- **Resources/evidence:** Collection tabs were closed. The supported stop
  wrapper failed closed because its launch shell parent had exited; the exact
  owned preview identity was revalidated before termination through the
  verifier isolation module, and process, listener, endpoint and state cleanup
  all passed. Corrected summaries are under
  [task-evidence/A01](task-evidence/A01/); full receipts remain in the
  task-owned OS-temp run `a01-corrected-20260907-162745`. Earlier receipts remain
