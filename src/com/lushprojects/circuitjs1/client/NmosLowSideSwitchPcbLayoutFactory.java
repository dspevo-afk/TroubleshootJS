...
final class NmosLowSideSwitchPcbLayoutFactory {
    ...
    static PcbBoardLayout create(TroubleshootBoard board,
        ...
        PcbBoardLayout layout = new PcbBoardLayout(1400, 800,
            new Rectangle(40 + shift, 30, 1050, 720), new Rectangle(1200, 125, 150, 255));
    ...
    private static void addComponents(PcbBoardLayout layout, TroubleshootBoard board,
        ...
        layout.addComponent(component("J2", 80 + s, 500, 100, 130, 74 + s, 494, 112, 142));
        layout.addComponent(component("RLOAD", 300 + s, 70, 220, 70, 312 + s, 75, 196, 60));
        layout.addComponent(component("RPD", 250 + s, 350, 220, 70, 258 + s, 355, 204, 60));
        layout.addComponent(component("LED1", 600 + s, 70, 90, 100, 610 + s, 80, 70, 80));
        addProviderFootprint(layout, board.getComponent("TP1"), 760 + s, 500, seed);
        addProviderFootprint(layout, board.getComponent("TP2"), 760 + s, 600, seed + 1);
    ...
    private static void addTraces(PcbBoardLayout layout, int s) {
        ...
        trace(layout, "CONTROL_INPUT", "J2.1", "TP2.1", 100+s,540, 200+s,540,
            200+s,680, 900+s,680, 900+s,580, 780+s,580, 780+s,630);
        trace(layout, "CONTROL_INPUT", "TP2.1", "TP2.2", 780+s,630, 780+s,580,
            830+s,580, 830+s,630);
        trace(layout, "GATE_DRIVE", "TP1.1", "TP1.2", 780+s,530, 780+s,490,
            830+s,490, 830+s,530);
        ...
        trace(layout, "DRAIN", "LED1.K", "Q1.D", 660+s,140, 700+s,140,
            700+s,260, 1010+s,260, 1010+s,222, 1010+s,190);
        trace(layout, "GATE", "RPD.1", "Q1.G", 250+s,385, 220+s,385,
            220+s,340, 540+s,340, 540+s,60, 940+s,60, 940+s,190, 970+s,190);
        trace(layout, "GND", "J1.2", "J2.2", 100+s,180, 60+s,180, 60+s,600, 100+s,600);
        ...
        trace(layout, "GND", "J1.2", "Q1.S", 100+s,180, 60+s,180,
            60+s,430, 1050+s,430, 1050+s,222, 1050+s,190);
    }
    ...
    private static void addLabels(PcbBoardLayout layout,
        ...
        String controlSupplyLabel = specifications.getPowerInputNameplate("CONTROL_VIN_INPUT")
            .getDisplayLabel();
        label(layout, "board-title", "TSJ NMOS LOW-SIDE", 500+s, 720, 170, 18, null);
        ...
        label(layout, "component:TP1", "GATE", 780+s, 450, 36, 18, null);
        label(layout, "component:TP2", "CTRL", 780+s, 690, 36, 18, null);
        ...
        label(layout, "net:J2.2", "GND", 250+s, 645, 30, 16, "J2.2");
    }
