    ...
    static Vector<GeneratedDiagnosticPlan> forFamily(String familyId) {
        ...
        if (QuickPlayFamilyRegistry.LED_INDICATOR.equals(familyId))
            result.add(simple("STEADY_STATE_COMPONENT_PATH", "J1.2",
                ...
                new String[] { WorkbenchOperation.CATALOG_INSTALL, WorkbenchOperation.INSTALL },
            ...
            result.add(simple("RC_POWER_CYCLE_TEMPORAL_CHECK", "J2.2",
            ...
            result.add(simple("NMOS_CONTROL_AND_GDS_TERMINAL_CHECK", "J1.2",
